...
```bash
git clone https://github.com/ApparitionEmperor/breathe-cli-586.git
cd breathe-cli-586
python setup.py
```
...
[![Homebrew](https://img.shields.io/badge/homebrew-tap-orange)](https://github.com/ApparitionEmperor/breathe-cli-586)
...
<!-- Last updated: 2026-06-06 16:21:23 -->
